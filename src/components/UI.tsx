...
export default function UI({ setActiveModal }: { setActiveModal: (modal: string | null) => void }) {
  return (
    <div className="html-container" style={{ position: 'relative', width: '100vw', height: '600vh', zIndex: 10 }}>
      
      {/* Page 1: Hero */}
      <section className="html-section" style={{ position: 'absolute', top: '0', left: 0, width: '100%' }}>
        <div className="max-w-4xl glass-text-bg">
          <motion.h1 
      ...
      {/* Page 2: The Chaos */}
      <section className="html-section dark-theme" style={{ position: 'absolute', top: '100vh', left: 0, width: '100%', backgroundColor: 'transparent' }}>
        <div className="max-w-4xl glass-text-bg">
      ...
      <section className="html-section" style={{ position: 'absolute', top: '200vh', left: 0, width: '100%', backgroundColor: 'transparent' }}>
        <div className="max-w-4xl glass-text-bg">
      ...
      {/* Page 4: The Profile */}
      <section className="html-section" style={{ position: 'absolute', top: '300vh', left: 0, width: '100%', background: 'var(--bg-color)' }}>
      ...
      <section className="html-section" style={{ position: 'absolute', top: '400vh', left: 0, width: '100%', background: 'var(--bg-color)' }}>
      ...
      <section className="html-section" style={{ position: 'absolute', top: '500vh', left: 0, width: '100%', justifyContent: 'flex-start', paddingTop: '10vh', background: 'var(--bg-color)' }}>
        <div className="max-w-4xl" style={{ marginBottom: '4rem', padding: '0 2rem' }}>
        ...
        <div className="assessment-container max-w-4xl" style={{ marginBottom: '4rem', padding: '0 2rem' }}>
        ...
        <div className="max-w-4xl" style={{ background: '#000', color: '#fff', width: 'calc(100% - 4rem)', padding: '5rem 3rem', borderRadius: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
